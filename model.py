...
def findImages(dataPath):
    ...
    for directory in dataDirectories:
        ...
        for line in lines:
            ...
            center.append(directory + '/IMG/' + line[0].split('\\')[-1].strip())
            left.append(directory + '/IMG/' + line[1].split('\\')[-1].strip())
            right.append(directory + '/IMG/' + line[2].split('\\')[-1].strip())
...
centerPaths, leftPaths, rightPaths, measurements = findImages('training')
